...
class FormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents() : array
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'quickcheck.form_aware_hook.article.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'quickcheck.form_aware_hook.article.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'quickcheck.form_aware_hook.messages.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'quickcheck.form_aware_hook.messages.process_delete'
        ];
    }

    public function getAreaName(): string
    {
        // TODO: Implement getAreaName() method.
        return 'subscriber.quickcheck.form_aware_hook.messages';
    }
}
