 ...
 */
function quickcheck_userapi_getall()
{
    $items = array();
 ...
 */
function quickcheck_userapi_get($args) {
    if(isset($args['id'])){
        $id = $args['id'];
    }
...
function quickcheck_userapi_getallquestions($args)
{
    if (!SecurityUtil::checkPermission('quickcheck::', '::', ACCESS_OVERVIEW)) {
        return false;
    }
...
function quickcheck_userapi_getquestion($args)
{
    $item = false;
    if (!SecurityUtil::checkPermission('quickcheck::', '::', ACCESS_OVERVIEW)) {
        return $item;
 ...
 */
function quickcheck_userapi_countitems()
{
