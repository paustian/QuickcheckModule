...
class AdminController extends \Zikula_AbstractController {
    ...
    public function main() {
        return  new RedirectResponse(ModUtil::url('quickcheck', 'admin', 'menu'));
    }
     ...
     */
    public function new_exam(Request $request) {
        ...
        if (!isset($art_id)) {
            return LogUtil::registerError(__('You must create quizzes from modules that hook to the quiz module'), null, ModUtil::url('quickcheck', 'admin', 'menu'));
        }
        switch ($button) {
            case 'create':
                ...
                return $render->fetch('quickcheck_admin_new.tpl');
                break;
            case 'modify':
            ...
            case 'attach':
                ...
                $render->assign('ret_url', $ret_url);
                $render->assign('art_id', $art_id);
                return $render->fetch('quickcheck_admin_attach.tpl');
                break;
        }
    }
...
//    create a new item and then add each to the list.
    ...
    public function create(Request $request) {
        ...
        if (!SecurityUtil::confirmAuthKey()) {
            return LogUtil::registerAuthidError(ModUtil::url('quickcheck', 'admin', 'new'));
        }
    ...
    public function newTextQuest($args) {
        ...
        return $render->fetch('quickcheck_admin_new_text_question.tpl');
    }

    public function createTextQuestion(Request $request) {
        $button = $request->request->get('submit',null);
    ...
    public function createMatchQuestion(Request $request) {
...
//set the type of question
                ...
                //if we have gotten here, we were successful
                return new RedirectResponse(ModUtil::url('quickcheck', 'admin', 'newMatchQuest'));
                break;
            case 'cancel':
                return new RedirectResponse(ModUtil::url('quickcheck', 'admin', 'view'));
                break;
    ...
    public function createTFQuest(Request $request) {
    ...
    public function createMCQuestion(Request $request) {
        //write this now to handle the form.
        //save the <pnform> stuff.
        $data['num_mc_choices'] = $request->request->get('num_mc_choices',null);
        $button = $request->request->get('submit',null);
    ...
    public function menu() {
        ...
        $render = zikula_View::getInstance('Quickcheck', false);
        // Return the output that has been generated by this function
        return $render->fetch('quickcheck_admin_menu.tpl');
    }
