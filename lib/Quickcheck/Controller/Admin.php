 ...
 * easier to read
 */
class Quickcheck_Controller_Admin extends Zikula_AbstractController {
...
//    create a new item and then add each to the list.
     ...
     * form supplied by quickcheck_admin_new_exam) to create a new item
     *
    ...
    public function create($args) {
        ...
        $items = modUtil::apiFunc('quickcheck', 'admin', 'create', array('questions' => $questions,
            'art_id' => $art_id,
            'name' => $name));
     ...
     */
    public function newTextQuest($args) {
        // Security check - important to do this as early as possible to avoid
        // potential security holes or just too much wasted processing
        if (!SecurityUtil::checkPermission('quickcheck::', '::', ACCESS_ADD)) {
    ...
    public function createTextQuestion($args) {
        $button = FormUtil::getPassedValue('submit', isset($args['submit']) ? $args['submit'] : null);
    ...
    private function _validate_createTextQuestion($inData) {
        ...
        if (($inData['q_text'] == "") || $inData['q_answer'] == "") {
            SessionUtil::setVar('statusmsg', $this->__("The question and/or answer are not filled in."));
            $is_ok = false;
        }
        return $is_ok;
    }
     ...
     * @return       The form for creating a new text question
     */
    public function newMatchQuest($args) {
        $args['q_type'] = _QUICKCHECK_MATCHING_TYPE;
        $render = $this->_setup_MANSMATCH_form($args);
        // Return the output that has been generated by this function
        return $render->fetch('quickcheck_admin_new_match_question.htm');
    }

    public function createMatchQuestion() {
...
//set the type of question
    ...
    private function _validate_createMatchQuestion($inData) {
        ...
        if (($inData['q_text'] == "") || $inData['q_explan'] == "") {
            SessionUtil::setVar('statusmsg', $this->__("The question and/or explanation are not filled in."));
            $is_ok = false;
        }
        $answers = $inData['q_answer'];
        foreach ($answers as $item_text) {
            if ($item_text == "") {
                SessionUtil::setVar('statusmsg', $this->__("One or more of your Facts is empty"));
                $is_ok = false;
                break;
            }
        }
        ...
        foreach ($matches as $item_text) {
            if ($item_text == "") {
                SessionUtil::setVar('statusmsg', $this->__("One or more of your Matching Concepts is empty"));
                $is_ok = false;
                break;
            }
        }
    ...
    public function createTFQuest($args) {
        $button = FormUtil::getPassedValue('submit', isset($args['submit']) ? $args['submit'] : null);
    ...
    private function _validate_TFQuestion($inData) {
        ...
        if (($inData['q_answer'] != '0' && $inData['q_answer'] != '1')) {
            SessionUtil::setVar('statusmsg', $this->__("You did choose true or false."));
            $is_ok = false;
        }
        return $is_ok;
    }
    ...
    public function newMCQuest($args) {
        ...
        $render->assign('pointer', ' $this->newMCQuest');
        $render->assign('formURL', pnModURL('Quickcheck', 'admin', 'createMCQuestion'));
        // Return the output that has been generated by this function
        return $render->fetch('quickcheck_admin_new_mc_question.htm');
    }

    public function createMCQuestion($args) {
        //write this now to handle the form.
        //save the <pnform> stuff.
    ...
    private function _validate_createMCQuestion($inData) {
        ...
        if ($inData['q_type'] != _QUICKCHECK_TEXT_TYPE) {
            ...
            if ($total_percent != 100) {
                SessionUtil::setVar('statusmsg', $this->__("The percent correct does not add up to 100"));
                $is_ok = false;
            }
        }
        ...
        foreach ($choices as $item_text) {
            if ($item_text == "") {
                SessionUtil::setVar('statusmsg', $this->__("One or more of your choices is empty"));
                $is_ok = false;
                break;
            }
        }
    ...
    public function newMANSQuest($args) {
        ...
        $render = $this->_setup_MANSMATCH_form($args);
        $render->assign('pointer', " $this->newMANSQuest");
    ...
    public function modify2($args) {
        ...
        if ($button === 'delete_exams') {
            ...
            SessionUtil::setVar('statusmsg', $this->__('The exams were deleted.'));
    ...
    public function modifyquest($args) {
        ...
        // Return the output that has been generated by this function
        return $render->fetch('quickcheck_admin_modifyquest.htm');
    }
    ...
    public function modifyMCQuest($args) {
    ...
    public function modifyMANSQuest($args) {
        $data = FormUtil::getPassedValue('item', isset($args['item']) ? $args['item'] : null);
    ...
    public function modifyMatchQuest($args) {
        $data = FormUtil::getPassedValue('item', isset($args['item']) ? $args['item'] : null);
    ...
    public function update($args) {
        ...
        if (modUtil::apiFunc('quickcheck', 'admin', 'update', array('name' => $name, 'id' => $id, 'questions' => $total_questions))) {
            SessionUtil::setVar('statusmsg', $this->__("The exam was updated."));
        }
    ...
    public function modifydeletequestions() {
        ...
        if ($button === 'delete_checked') {
            ...
            if (!empty($questions)) {
                ...
                SessionUtil::setVar('statusmsg', $this->__("The choosen question(s) were deleted"));
            } else {
                if ($delete_all == "on") {
                    ...
                    SessionUtil::setVar('statusmsg', $this->__("All questions were deleted"));
    ...
    public function menu() {
        ...
        $render = zikula_View::getInstance('Quickcheck', false);
        // Return the output that has been generated by this function
        return $render->fetch('quickcheck_admin_menu.htm');
    }
    ...
    public function manageexams($args) {
        ...
        if ($exam) {
            $ret_text = pnModFunc('quickcheck', 'user', 'display', array('exam' => $exam, 'returnurl' => $ret_url));
            $render = zikula_View::getInstance('Quickcheck', false);
        ...
        if (!SecurityUtil::checkPermission('quickcheck::', "::", ACCESS_EDIT)) {
            ...
            $ret_text .= "<hr />" . pnModFunc('quickcheck', 'admin', 'pickquestions', array('returnurl' => $ret_url, 'art_id' => $art_id));
        }
        return $ret_text;
    }
...
//a short function for cleaning up the array of exam questions
    public function clean() {
        ...
        SessionUtil::setVar('statusmsg', $this->__("It worked."));
        return true;
    }
...
// load the categories system
    ...
    public function addtocategory($args) {
        // Confirm authorisation code.
        ...
        //if we have gotten here, we were successful
        SessionUtil::setVar('statusmsg', $this->__('Categories updated.'));
...
// Confirm authorisation code.
        ...
        if (modUtil::apiFunc('quickcheck', 'admin', 'import', array('questions' => $questions))) {
            SessionUtil::setVar('statusmsg', $this->__('Import of questions was successful.'));
            ;
        } else {
