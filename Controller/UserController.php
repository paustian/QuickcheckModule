...
use modules\Quickcheck\lib\Quickcheck\Entity\QuickcheckQuestionEntity;
use ModUtil;
...
class UserController extends Zikula_AbstractController {
    ...
    public function main() {
        return new RedirectResponse(ModUtil::url('quickcheck', 'user', 'view'));
    }
    ...
    public function view($args) {
        ...
        return $render->fetch('quickcheck_user_makequiz.tpl');
    }
...
// Return the output that has been generated by this function
        return $render->fetch('quickcheck_user_display.tpl');
    }
...
//score is calculated, now I need to display it with the questions.
        ...
        return $render->fetch('quickcheck_user_gradequiz.tpl');
    }
