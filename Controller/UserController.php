...
class UserController extends \Zikula_AbstractController {
    ...
    public function indexAction() {
        ...
        usort($cats, "UserController::sort_cat_array");
        $render->assign('cats', $cats);
        // Return the output that has been generated by this function
        return new Response($render->fetch('User\quickcheck_admin_makequiz.tpl'));
    }
...
//stopped here. I need to sort the question by their cat id, makes it easy for picking them out
    ...
    public function renderquizAction() {
         //security check
        $this->checkCsrfToken();
        ...
        $questions = modUtil::apiFunc('paustianquickcheckmodule', 'user', 'getallquestions');
        usort($questions, "UserController::sort_by_catid");
        ...
        return new Response($this->_display_quiz($quiz_questions, $ret_url, "", $notice));
    }
...
// Return the output that has been generated by this function
        return $render->fetch('User\quickcheck_admin_display.tpl');
    }
